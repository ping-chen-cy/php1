...
$sql = 'INSERT INTO cust (cname,tel,birthday) VALUES ("ping","123","1990-03-31")' ;
// .= 字串相加
// VALUES 後 以 ,分隔 可以新增多筆
$sql .= ', ("ping2","1234","1990-03-31")';
$sql .= ', ("ping3","1235","1990-03-31")';
$sql .= ', ("ping4","1236","1990-03-31")';
//mysqli prepare:
// prepare 最大的功效 有變數
